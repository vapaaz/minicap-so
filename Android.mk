...
$(warning =============> build minicap.so, OVERRIDE_PLATFORM_SDK_VERSION is $(OVERRIDE_PLATFORM_SDK_VERSION), PLATFORM_SDK_VERSION is $(PLATFORM_SDK_VERSION))
ifneq ($(OVERRIDE_PLATFORM_SDK_VERSION),)
LOCAL_SRC_FILES += src/minicap_$(OVERRIDE_PLATFORM_SDK_VERSION).cpp
else ifeq ($(PLATFORM_SDK_VERSION),35)
LOCAL_SRC_FILES += src/minicap_35.cpp
else ifeq ($(PLATFORM_SDK_VERSION),34)
LOCAL_SRC_FILES += src/minicap_34.cpp
